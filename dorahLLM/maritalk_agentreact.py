...
if __name__ == '__main__':
    ...
    model = MariTalkLLM()
    g_param = {'engine': 'google', 'gl': 'br', 'google_domain': 'google.com', 'hl': 'pt'}
    search = SerpAPIWrapper(params=g_param, serpapi_api_key=g_key)
    wikipedia = WikipediaAPIWrapper(lang='pt', top_k_results=2)
    tools = [
        Tool.from_function(
            func=wikipedia.run,
            name="Wikipedia",
