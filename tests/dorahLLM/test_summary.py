from src.dorahLLM.browserless import text_sites_test
# from src.dorahLLM.maritalk_summary import summary_text_test


def test_load_site():
    texts_date = text_sites_test(['https://brasilescola.uol.com.br/historiab/independencia-brasil.htm', 'https://br.usembassy.gov/slide/brazil-national-day/independe%CC%82ncia-do-brasil-carrossel/', 'https://www.al.sp.gov.br/noticia/?07/09/2021/independencia-do-brasil-completa-199-anos-nesta-terca-feira--7-de-setembro', 'https://br.usembassy.gov/pt/dia-da-independencia-do-brasil-4/', 'https://www.amazon.com/Escravidao-Independencia-Brasil-Aurea-Portugues/dp/6559870529'])
